...
import LinkKnowledge from "./components/LinkKnowledge";
...
const TrainingPage: React.FC = () => {
  ...
  const handleGeneralKnowledgeChange = (
        ...
        <Tabs aria-label="Default tabs">
          ...
          <Tabs.Item title="ความรู้ ถาม-ตอบ" icon={FaRegQuestionCircle}>
            <KnowledgeQA
              ...
              onChangeKnowledgeState={(newKnowledgeItems) =>
                setKnowledgeItems(newKnowledgeItems as KnowledgeItem[])
              }
            />
          </Tabs.Item>
          <Tabs.Item title="รูปภาพ" icon={FaRegImage}>
            <ImageGallery
              ...
              onChangeImageState={(newImageItems) =>
                setImageItems(newImageItems as ImageItem[])
              }
            />
          </Tabs.Item>
          <Tabs.Item title="URL" icon={IoIosLink}>
            <LinkKnowledge
              folder_id={id}
